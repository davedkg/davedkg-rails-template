...
if Rails.env.development?
  class RequestSpecsGenerator < Rails::Generators::NamedBase
    ...
    def copy_request_specs
      template 'DELETE_object_spec.rb',
              File.join('spec/requests', plural_name, "DELETE_#{plural_name.singularize}_spec.rb")
      template 'GET_edit_object_spec.rb',
              File.join('spec/requests', plural_name, "GET_edit_#{plural_name.singularize}_spec.rb")
      template 'GET_new_object_spec.rb',
              File.join('spec/requests', plural_name, "GET_new_#{plural_name.singularize}_spec.rb")
