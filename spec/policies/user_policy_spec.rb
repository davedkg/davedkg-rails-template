...
describe UserPolicy do
  ...
  context 'as a user' do
    it { is_expected.to forbid_actions([ :index, :new, :create, :show, :edit, :update, :destroy, :update_password, :update_avatar, :resend_invitation_email, :send_reset_password_email ,:unlock ]) }
    ...
    context "when record is me" do
      ...
      it { is_expected.to permit_actions([ :show, :edit, :update, :update_password, :update_avatar ]) }
    end
  end
  ...
  context "as an admin" do
    ...
    it { is_expected.to forbid_actions([ :edit, :update, :update_password, :update_avatar ]) }
